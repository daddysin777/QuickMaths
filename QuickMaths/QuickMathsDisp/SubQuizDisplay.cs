...
{
    public partial class SubQuizDisplay : UserControl
    {
        int n = -1;
        Quiz q = new Quiz();
        public SubQuizDisplay()
        {
            InitializeComponent();
        }

        private void SubQuizDisplay_Load(object sender, EventArgs e)
        {
        ...
        private void EnterAnsBtn_Click(object sender, EventArgs e)
        {
            ...
            else if (q.SubQuizCheck(Convert.ToInt32(Anstxtbox.Text)) == 1)
            {
